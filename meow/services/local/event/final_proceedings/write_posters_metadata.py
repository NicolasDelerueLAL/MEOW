...
async def write_posters_metadata(
    ...
    posters_data: list[FileData] = await extract_proceedings_posters(
        proceedings_data,
        callback,
    )
...
# async def write_metadata_task_and_frame(
#     proceedings_data: ProceedingsData,
#     current_file_data: FileData,
#     sessions: dict,
#     settings: dict,
#     pdf_cache_dir: str,
# ):
#     current_file: FileData = current_file_data.poster
#
#     contribution: ContributionData = current_file_data.contribution
#
